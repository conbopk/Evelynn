      ...
      <CardContent className='p-2 sm:p-3'>
        ...
        <div className='space-y-3'>
          <div className='grid grid-cols-2 gap-2'>
            <div>
              <label htmlFor="width" className='mb-1 flex items-center gap-1 text-xs font-semibold'>
          ...
          <div>
            <label htmlFor="steps" className='mb-1 flex items-center justify-between text-xs font-semibold'>
              <span className='flex items-center gap-1'>
                <Settings className='w-3 h-3'/> Steps
              </span>
          ...
          <div>
            <label htmlFor="guidance" className='mb-1 flex items-center justify-between text-xs font-semibold'>
              <span className='flex items-center gap-1'>
                <Settings className='w-3 h-3'/> Guidance
              </span>
          ...
          <div>
            <label htmlFor="seed" className='mb-1 flex items-center gap-1 text-sm font-semibold'>
          ...
          <div className='space-y-2'>
            ...
            <Button
              ...
              className='h-9 w-full gap-2 cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700'
            >
              {isGenerating ? (
