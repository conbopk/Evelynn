...
We aim to acknowledge your report within **48 hours** and will provide a more detailed response within **5 business day**.
...
- We will credit you in the release notes (unless you prefer ti remain anonymous)
...
- **Database** is not public accessible; use connection pooling with SSL
- **Environment variables** are never commited to source control
